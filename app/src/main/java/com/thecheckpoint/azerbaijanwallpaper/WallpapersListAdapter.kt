...
class WallpapersListAdapter(var wallpapersList: List<WallpaperModel>, private val clickListener: (WallpaperModel) -> Unit): RecyclerView.Adapter<WallpapersListAdapter.WallpapersViewHolder>(){
